...
const OurTeamMember = () => {
    return (
        <div className="border-dotted border-b border-t border-indigo-500">
            ...
            <section className="p-6 dark:bg-gray-100 dark:text-gray-800 border-dotted border-t border-b border-indigo-500">
                <div className="container p-4 mx-auto text-center">
                    <h2 className="text-4xl font-bold text-emerald-900">Trusted by the industry leaders</h2>
                </div>
